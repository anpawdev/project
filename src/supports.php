...
if ( ! function_exists( 'fairp_add_theme_supports' ) ) {
	/**
	 ...
	 * @return void
	 */
	function fairp_add_theme_supports() {
		/**
...
add_action( 'after_setup_theme', 'fairp_add_theme_supports' );

if ( ! function_exists( 'fairp_load_textdomain' ) ) {
	/**
	 ...
	 * @return void
	 */
	function fairp_load_textdomain() {
		load_theme_textdomain( 'fairp', get_template_directory() . '/resources/languages' );
	}
}
add_action( 'after_setup_theme', 'fairp_load_textdomain' );
